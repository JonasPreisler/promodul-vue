...
companiesChart: {
 ...
 userChart: {
    ...
    created(){
      ...
      ApiService.get("/planner_owners/company_stats/"+this.$route.params.id).then(
      response => {
                  ...
                  this.resourcesChart.series[0].data = [
                    ...
                    { value: response.data.users.admin, name: this.$t("common.Admin") },                  
                  ]
  ...
  <Layout>
    ...
    <div class="row">
      <div class="col-lg-6">
        <div class="card">
          <div class="card-body">
            <h4 class="text-center">{{this.$t("common.Projects")}}</h4>
            <hr>
      ...
      <div class="col-lg-6">
        <div class="card">
          <div class="card-body">
            <h4 class="text-center">{{this.$t("common.Tasks")}}</h4>
            <hr>
      ...
      <div class="col-lg-6">
        <div class="card">
          <div class="card-body">
            <h4 class="text-center">{{this.$t("common.Resources")}}</h4>
            <hr>
      ...
      <div class="col-lg-6">
        <div class="card">
          <div class="card-body">
            <h4 class="text-center">{{this.$t("common.Employees")}}</h4>
            <hr>
